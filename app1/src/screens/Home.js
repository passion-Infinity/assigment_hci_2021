      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.header_bottom}>
            <Text style={styles.header_title}>
              Thuê máy tính chất lượng và tiết kiệm với Forento
            </Text>
          </View>
        </View>
        <View style={styles.main_content}>
          ...
          <ScrollView>
                ...
                <View style={styles.category_content}>
                  ...
                  <View style={styles.category_wrapper}>
                    <View style={styles.category_item}>
                      <Pressable>
                        <Image
                          source={require('../assets/images/game64.png')}
                        />
                      </Pressable>
                    </View>
                  ...
                  <View style={styles.category_wrapper}>
                    <View style={styles.category_item}>
                      <Pressable>
                        <Image
                          source={require('../assets/images/relax64.png')}
                        />
                      </Pressable>
                    </View>
                  ...
                  <View style={styles.category_wrapper}>
                    <View style={styles.category_item}>
                      <Pressable>
                        <Image
                          source={require('../assets/images/other32.png')}
                        />
                      </Pressable>
                    </View>
                  ...
                  return (
                    <View style={styles.hot_item} key={index}>
                      <View style={styles.hot_item_top}>
                        ...
                        <Text style={styles.hot_item_info}>Hot</Text>
                      </View>
            ...
            {/* Popular product */}
            <View style={styles.product}>
              <Text style={styles.product_title}>Sản phẩm mới cập nhật</Text>
